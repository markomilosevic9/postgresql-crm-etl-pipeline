...
The codebase demonstrates the design and implementation of an pipeline, including schema setup, mock data generation, data validation, deduplication, and loading from source CRM tables into dimensional models and fact tables. The project also includes data quality checks and issue logging.
