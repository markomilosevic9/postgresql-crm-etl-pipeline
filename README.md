...
# Goal
This project implements a PostgreSQL ETL pipeline for processing mock CRM-like data (customers, plans, subscriptions, and transactions) with the goal of analyzing sales performance. The codebase covers schema setup, data validation, deduplication, and loading from source CRM tables into dimensional models and fact tables. The project also includes data quality checks and issue logging.
